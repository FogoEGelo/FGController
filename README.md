...
| **`.PlayCharAnimation()`** | `Animation: Animation`<br>`Char: Model` | `AnimationTrack` | Returns a animation track to play your player animation more easily, to play it's just use `:Play()`. |
